...
# 1. Sabse upar Page Config
st.set_page_config(page_title="Workorder Analytics", page_icon="🎯", layout="wide")

# 2. Header Hide karne ka adjustment
st.markdown("""
    <style>
...
if not st.session_state.authenticated:
    ...
    st.stop() # Jab tak login nahi hoga, niche wala 639 lines ka code nahi chalega
import streamlit as st
import pandas as pd
from datetime import datetime
import plotly.express as px
